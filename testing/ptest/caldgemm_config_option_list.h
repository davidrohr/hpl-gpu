...
HPL_fprintf( TEST->outfp, " - CALDGEMM_MERGE_NOPS %d", CALDGEMM_MERGE_NOPS);
#endif
...
HPL_fprintf( TEST->outfp, " - CALDGEMM_SHIFT_TEXTURE %d" CALDGEMM_SHIFT_TEXTURE);
#endif
...
HPL_fprintf( TEST->outfp, " - CALDGEMM_DIVIDE_BLOCKING %d", CALDGEMM_DIVIDE_BLOCKING);
#endif
